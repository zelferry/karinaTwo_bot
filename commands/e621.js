...
let yeste = "c"
 let author = message.author;
  ...
  msg = message.channel.send(ava)
  }else{
    message.channel.send(":(")
    msg = message.author.send(ava)
  }
...
//se a PUBLICAÇÃO tiver TAGS, o IF e acionado
 if(tags) {
   //se as tags tiverem alguma tag na blacklist, o If e acionado
  if (findOne(blacklist,tags)){
    //fazendo asim que o FILE fique bloqueado para ser visto
    file = "https://en.wikifur.com/w/images/d/dd/E621Logo.png";
    //e redefinindo a DESCRIÇÃO da imagem
    cestis = `**tag(s) na blak-list!** - tag(s): \`${getOne(blacklist,tags)}\` | [**Link**](https://e621.net/posts/${id})`;
  }
}
